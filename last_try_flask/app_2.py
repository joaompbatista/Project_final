...
def preprocess_image(image_path):
    ...
    if img_preds>= 0.9: 
        out = ('Hum...not good news. There is a {:.2%} percent chance that you have Pneumonia'.format(img_preds[0][0]))
    elif img_preds>= 0.5:
        ...
        out = ('Good news my dear patient - your lungs look marvelous. No pneumonia here. May the god of transistors be with you!')
